...
CanvasDisplay.prototype.drawActors = function() {
  this.level.actors.forEach(function(actor) {
    ...
    if (actor.type === "player") {
      ...
      if (actor.color === 'red') {
        this.cx.drawImage(otherSprites, 471, 65, 16, 16, x, y, scale, scale); // red
      } else if (actor.color === 'pink') {
        this.cx.drawImage(otherSprites, 471, 81, 16, 16, x, y, scale, scale); // pink
      } else if (actor.color === 'turq') {
        this.cx.drawImage(otherSprites, 471, 97, 16, 16, x, y, scale, scale); // turq
      } else {
        this.cx.drawImage(otherSprites, 471, 113, 16, 16, x, y, scale, scale); // yell
      }
